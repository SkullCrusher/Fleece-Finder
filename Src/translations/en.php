...
define("MESSAGE_USERNAME_BAD_LENGTH", "Username cannot be shorter than 4 or longer than 64 characters");
...
define("MESSAGE_USERNAME_INVALID", "Username does not fit the name scheme: only a-Z and numbers are allowed, 4 to 64 characters");
...
define("WORDING_REGISTRATION_USERNAME", "Username (only letters and numbers, 4 to 64 characters)");
