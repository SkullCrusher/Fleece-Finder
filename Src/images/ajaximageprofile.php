			...
			if(strlen($name)){
				...
				if($size<(2048*1024)){
						...
						if(move_uploaded_file($tmp, $path.$actual_image_name)){
							...
							echo "<img src='" . "http://www.scriptencryption.com/images/upload_images/" . $_SESSION['user_name'] . '/' . $actual_image_name."' style='visibility: hidden;' height='0' width='0' class='preview'>";
							...
							echo '<script>var x = document.getElementById("currentpicture_1");x.src = "' . 'http://www.scriptencryption.com/images/upload_images/' . $_SESSION['user_name'] . '/' . $actual_image_name .'";</script>';
