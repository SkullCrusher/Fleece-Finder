...
*/
 ...
 <div class="container_12 backgroundwhite">
		...
		<form method="post" action="product_create.php" id="create_product_new" name="create_product_new">
				...
				<div class="grid_5" style="padding-left:10px;padding-bottom:15px;text-align:center">
        ...
        <div class="grid_5" style="float:right;padding-right:10px;text-align:center">
          ...
          <div class="grid_4" style="padding-left:70px">
         ...
         <div class="grid_3">
        <label for="unit"><b>Units</b></label><br>
				<div class="select-style">
        ...
        <div class="grid_12" style="padding-bottom:15px;text-align:center">
          <div class="grid_2" style="padding-left:70px;text-align:center">
				...
				<input type="checkbox" class="textbox" name="shipping_cost_multiple" value="yes"></div><br>
      </div><br>
